...
export default class Money extends Component {
  ...
  async checkUserLevel() {
    await Axios.post('/checkUserLevel', JSON.parse(localStorage.getItem('user')))
      .then(userstatus => this.setState({ isAdm: userstatus.data }))
      .catch(error => alert(`Erro na consulta do Nivel de Usuário -> ${error}`))
  }
  ...
  render() {
    return (
      <Content>
        {
          this.state.isLoading ? <Loader color='pictonBlue' /> :
                    ...
                    <div className='money-content-info-payment'>
                      ...
                      <div className='money-content-info-payment-ok'>
                        <div className='money-content-info-payment-ok-users'>
                          <p>Fábio Oliveira {this.state.isAdm ? <img src={ChecktrueIcon} alt='check-true' /> : null}</p>
                          <p>Filipe {this.state.isAdm ? <img src={ChecktrueIcon} alt='check-true' /> : null}</p>
                          <p>Thiago {this.state.isAdm ? <img src={ChecktrueIcon} alt='check-true' /> : null}</p>
                          <p>Jean Santos {this.state.isAdm ? <img src={ChecktrueIcon} alt='check-true' /> : null}</p>
                        </div>
                      </div>
                      <div className='money-content-info-payment-pending'>
                        ...
                        <div className='money-content-info-payment-pending-users'>
                          <p>Wagner Zuffi {this.state.isAdm ? <img src={CheckfalseIcon} alt='check-false' /> : null}</p>
                          <p>Erivelton Soares {this.state.isAdm ? <img src={CheckfalseIcon} alt='check-false' /> : null}</p>
                        </div>
                      </div>
                    </div>
